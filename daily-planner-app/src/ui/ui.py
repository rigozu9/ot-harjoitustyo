...
class UI:
    def __init__(self, root, user_service, daily_planner_service, survey_service):
        self._root = root
    ...
    def start(self):
        RegistrationForm(self._root, self._user_service, self._daily_planner_service, self._survey_service)